...

{
 ...
 programs.starship.settings.username = {
  show_always = true;
  style_user = "bg:#${config.lib.stylix.colors.base09} fg:#${config.lib.stylix.colors.base00}";
  style_root = "bg:#${config.lib.stylix.colors.base08} fg:#${config.lib.stylix.colors.base00}";
  format = "[ $user ]($style)";
 };

 programs.starship.settings.directory = { 
   style = "fg:#${config.lib.stylix.colors.base00} bg:#${config.lib.stylix.colors.base0A}";
   format = "[ $path ]($style)";
   truncation_length = 3;
   truncation_symbol = "…/";
   substitutions = {
 ...
 programs.starship.settings.git_branch = {
   ...
   format = "[[ $symbol $branch ](fg:#${config.lib.stylix.colors.base00} bg:#${config.lib.stylix.colors.base0B})]($style)";
 };

 programs.starship.settings.git_status = {
   style = "bg:#${config.lib.stylix.colors.base0B}";
   format = "[[($all_status$ahead_behind )](fg:#${config.lib.stylix.colors.base00} bg:#${config.lib.stylix.colors.base0B})]($style)";
 };

 programs.starship.settings.nodejs = {
   symbol = "";
   style = "bg:#${config.lib.stylix.colors.base0D}";
   format = "[[ $symbol( $version) ](fg:#${config.lib.stylix.colors.base00} bg:#${config.lib.stylix.colors.base0D})]($style)";
 };
