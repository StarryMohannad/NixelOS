...

{
 programs.firefox.profiles."starry".arkenfox = {
   ...
   "2800" = {
     enable = true;
     "2815"."privacy.clearOnShutdown.cookies".enable = false;
     "2815"."privacy.clearOnShutdown.offlineApps".enable = false;
     "2815"."privacy.clearOnShutdown.sessions".enable = false;
     "2815"."privacy.clearOnShutdown_v2.cookiesAndStorage".enable = false;
   };
   "4000".enable = true;
   "4500".enable = true;
   "5000".enable = true;
